...
var PouchManager = (function () {
  var pouch = new PouchDB("InfinityPouchManager", {revs_limit: 1, size: 50});
  //var couchURL = getCouchURL().then(res => {  pouch = new PouchDB(res) })
  ...
  function PouchManager() {
	...
	PouchManager.prototype.saveToDatabase = function(recordKey, recordData, onSuccess, onFail) {
      //var pouch = new PouchDB("InfinityPouchManager", {revs_limit: 1, auto_compaction: true, size: 50});
      pouch.get(recordKey)
            .then(function (doc) {
